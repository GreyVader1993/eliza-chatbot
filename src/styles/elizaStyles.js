export const elizaStyles = {
  ...
  header: {
    container: "text-center mb-8 border-2 border-green-400 p-6 bg-opacity-10",
  ...
  input: {
    ...
    button: "px-8 py-4 bg-opacity-30 border-2 border-green-400 text-green-400 font-mono text-base cursor-pointer transition-all duration-300 hover:bg-opacity-50 hover:shadow-lg hover:shadow-green-400/70 disabled:opacity-50 disabled:cursor-not-allowed"
  },
